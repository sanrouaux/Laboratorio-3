...
class Usuario {
    ...
    */
    public function __construct($correo, $clave, $nombre, $apellido, $legajo, $perfil, $foto) {
        $this->correo = $correo;
        $this->clave = $clave;
        $this->nombre = $nombre;
    ...
    */
    public static function Alta($usuario) {
        ...
        if(!$existeEnBD) {
            ...
            if($fotoArchivada) {
                $objAccesoDatos = AccesoDatos::dameUnObjetoAcceso();
                $consulta = $objAccesoDatos->RetornarConsulta('INSERT INTO usuarios (correo, clave, nombre, apellido, legajo, perfil, foto) VALUES (:correo, :clave, :nombre, :apellido, :legajo, :perfil, :foto)');
    ...
    * @return TRUE si logro borrar el usuario; FALSE caso contrario
    */
