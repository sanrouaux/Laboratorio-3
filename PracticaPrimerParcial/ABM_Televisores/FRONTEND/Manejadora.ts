...
namespace PrimerParcial {
    export class Manejadora {
        ...
        public static LimpiarForm() {
            ...
            let asteriscos = (<HTMLCollection>document.getElementsByClassName("span"));
        ...
        public static AdministrarValidaciones() {
            ...
            let marcasValidas: string[] = ['Samsung', 'Sony', 'Electrolux', 'Philco', 'VGH', 'Sanyo'];
            let tiposValidos: string[] = ['LCD', 'lcd', 'LED', 'led', 'Tubos', 'tubos', 'Plasma', 'plasma', '4K', '8K'];
            ...
            if (Manejadora.ValidarCamposVacios("marca") && Manejadora.ValidarTipo((<HTMLInputElement>document.getElementById("marca")).value, marcasValidas)) {
