...
(function (PrimerParcial) {
    var Manejadora = /** @class */ (function () {
        ...
        Manejadora.LimpiarForm = function () {
            ...
            var asteriscos = document.getElementsByClassName("span");
            for (var i = 0; i < asteriscos.length; i++) {
                asteriscos[i].remove();
            }
            var boton = document.getElementById("btn-agregar");
            boton.value = "Agregar";
        ...
        Manejadora.AdministrarValidaciones = function () {
            ...
            var marcasValidas = ['Samsung', 'Sony', 'Electrolux', 'Philco', 'VGH', 'Sanyo'];
            var tiposValidos = ['LCD', 'lcd', 'LED', 'led', 'Tubos', 'tubos', 'Plasma', 'plasma', '4K', '8K'];
            ...
            if (Manejadora.ValidarCamposVacios("marca") && Manejadora.ValidarTipo(document.getElementById("marca").value, marcasValidas)) {
